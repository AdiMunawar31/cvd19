<template>
  <div class="bg-transparent pt-2">
    <div
      class="flex pb-5 px-3 m-auto pt-5 border-t text-gray-200 text-sm flex-col md:flex-row"
    >
      <div class="mt-2">
        © Copyright 2021 | D2Y CODING. All Rights Reserved.
      </div>
      <div class="md:flex-auto md:flex-row-reverse mt-2 flex-row flex">
        <a href="/#" class="w-6 mx-1">
          <svg
            class="fill-current cursor-pointer text-gray-200 hover:text-gray-400"
            width="100%"
            height="100%"
            viewBox="0 0 24 24"
            version="1.1"
        ...
        <a href="/#" class="w-6 mx-1">
          <svg
            class="fill-current cursor-pointer text-gray-100 hover:text-gray-400"
            width="100%"
            height="100%"
            viewBox="0 0 24 24"
            version="1.1"
